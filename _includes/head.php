...
<html lang="en">
    <head>
        ...
        <!-- Favicons -->
        <link rel="preload" href="<?php the_assets_dir( '/css/style.css' ); ?>" as="style">
        <link rel="stylesheet" href="<?php the_assets_dir( '/css/style.css' ); ?>" type="text/css" media="print" onload="this.media='all'">
        <noscript><link rel="stylesheet" href="<?php the_assets_dir( '/css/style.css' ); ?>" type="text/css" media="all"></noscript>
