                ...
                <div class="flex flex--middle">
                    ...
                    <div class="col col--12 site-images-container">
                        <div class="site-images">
                            <a href="/projects/<?php echo $project['slug']; ?>"><img src="<?php images_dir( $project['slug'] . '/' . $project['slug'] . '-alt.jpg'); ?>" alt="<?php echo $project['name']; ?> screenshot of blog page" class="site-image alt-image"></a>
                            <a href="/projects/<?php echo $project['slug']; ?>"><img src="<?php images_dir( $project['slug'] . '/' . $project['slug'] . '-main.jpg'); ?>" srcset="<?php images_dir( $project['slug'] . '/' . $project['slug'] . '-main-300x225.jpg 300w'); ?>, <?php images_dir( $project['slug'] . '/' . $project['slug'] . '-main-768x576.jpg 768w'); ?>, <?php images_dir( $project['slug'] . '/' . $project['slug'] . '-main-1024x768.jpg 1024w'); ?>, <?php images_dir( $project['slug'] . '/' . $project['slug'] . '-main.jpg'); ?> 1200w" sizes="(max-width: 350px) 300px, (max-width: 800px) 768px, 1200px" alt="<?php echo $project['name']; ?> screenshot of home page" class="site-image main-image"></a>
                            <a href="/projects/<?php echo $project['slug']; ?>"><img src="<?php images_dir( $project['slug'] . '/' . $project['slug'] . '-mobile.jpg'); ?>" alt="<?php echo $project['name']; ?> screenshot of mobile page" class="site-image mobile-image"></a>
                        </div>
                    </div>
                </div>
            </div>
