                ...
                <header class="flex flex--middle">
                    ...
                    <div class="col col--12 site-images-container">
                        <div class="site-images">
                            <img src="/assets/images/embracing-a-simpler-life/embracing-a-simpler-life-alt.jpg" alt="Embracing a simpler life screenshot of blog page" class="site-image alt-image">
                            <img src="/assets/images/embracing-a-simpler-life/embracing-a-simpler-life-main.jpg" alt="Embracing a simpler life screenshot of home page" class="site-image main-image">
                            <img src="/assets/images/embracing-a-simpler-life/embracing-a-simpler-life-mobile.jpg" alt="Embracing a simpler life screenshot of mobile site" class="site-image mobile-image">
                        </div>
                    </div>
                </header>
            </div>
        ...
        <div class="full-width padding-top--lg padding-bottom--xxl">
            <div class="container content margin-top--xxl margin-bottom--xxl">
                <p>Embracing a Simpler Life was a growing blog that required a platform and look to match her growing audience. The custom Wordpress theme was designed by <a href="https://pautlerdesign.com">Pautler Design</a>. The development of this site was early on in my career but my commitment clean and maintainable cade and proved beneficial as new features and customizations have been added. The site has stood the test of time.</p>                <figure class="wp-block-image size-large">
                    <img src="/assets/images/embracing-a-simpler-life/embracing-a-simpler-life-main.jpg" alt="Embracing a simpler life screenshot of home page">
                </figure>
            </div>
        </div>
    </article>
