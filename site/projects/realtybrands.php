    ...
    <header id="masthead" class="full-width">
        <div id="site-header-menu" class="container header--container flex flex--middle flex--between">
            <div class="site-logo-wrapper">
                <a href="/"><img src="/assets/images/logo-horizontal.svg" /></a>
            </div>
            ...
            <nav id="site-navigation" role="navigation" class="header__nav">
                <ul id="menu-home-page" class="menu">
                    ...
                    <li class="menu-item"><a href="/projects">Portfolio</a></li>
                ...
                <header class="flex flex--middle">
                    ...
                    <div class="col col--12 site-images-container">
                        <div class="site-images">
                            <img src="/assets/images/realtybrands/realtybrands-alt.jpg" alt="Embracing a simpler life screenshot of blog page" class="site-image alt-image">
                            <img src="/assets/images/realtybrands/realtybrands-main.jpg" alt="Embracing a simpler life screenshot of home page" class="site-image main-image">
                            <img src="/assets/images/realtybrands/realtybrands-mobile.jpg" alt="Embracing a simpler life screenshot of mobile site" class="site-image mobile-image">
                        </div>
                    </div>
                </header>
            </div>
        ...
        <div class="full-width padding-top--lg padding-bottom--xxl">
            <div class="container content margin-top--xxl margin-bottom--xxl">
                <p>Realty Brands was my most ambitious project to date. It includes a custom CMS with a variety of tools to help real estate agents. It includes front-end websites and back-end tools such as a basic CRM, support portal, website statistics, and more. This project gave me a deep understanding of PHP and brought my skills far beyond those of an average front-end web developer. All of the elements that I built were also designed by me.</p>                <figure class="wp-block-image size-large">
                    <img src="/assets/images/realtybrands/realtybrands-main.jpg" alt="Embracing a simpler life screenshot of home page">
                </figure>
            </div>
        </div>
    </article>
