                ...
                <header class="flex flex--middle">
                    ...
                    <div class="col col--12 site-images-container">
                        <div class="site-images">
                            <img src="/assets/images/AGB/AGB-alt.jpg" alt="Embracing a simpler life screenshot of blog page" class="site-image alt-image">
                            <img src="/assets/images/AGB/AGB-main.jpg" alt="Embracing a simpler life screenshot of home page" class="site-image main-image">
                            <img src="/assets/images/AGB/AGB-mobile.jpg" alt="Embracing a simpler life screenshot of mobile site" class="site-image mobile-image">
                        </div>
                    </div>
                </header>
            </div>
        ...
        <div class="full-width padding-top--lg padding-bottom--xxl">
            <div class="container content margin-top--xxl margin-bottom--xxl">
                <p>A Great Baby was looking to platforms to Shopify. The custom Shopify theme was designed by <a href="https://rekreate.agency">re•kreate</a> and brought new life to this eCommerce store. Perhaps the biggest improvement was the ease of use for the clients and (more so) the business owner.</p>                <figure class="wp-block-image size-large">
                    <img src="/assets/images/AGB/AGB-main.jpg" alt="Embracing a simpler life screenshot of home page">
                </figure>
            </div>
        </div>
    </article>
