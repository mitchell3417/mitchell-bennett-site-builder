                ...
                <header class="flex flex--middle">
                    ...
                    <div class="col col--12 site-images-container">
                        <div class="site-images">
                            <img src="/assets/images/fayette/fayette-alt.jpg" alt="Embracing a simpler life screenshot of blog page" class="site-image alt-image">
                            <img src="/assets/images/fayette/fayette-main.jpg" alt="Embracing a simpler life screenshot of home page" class="site-image main-image">
                            <img src="/assets/images/fayette/fayette-mobile.jpg" alt="Embracing a simpler life screenshot of mobile site" class="site-image mobile-image">
                        </div>
                    </div>
                </header>
            </div>
        ...
        <div class="full-width padding-top--lg padding-bottom--xxl">
            <div class="container content margin-top--xxl margin-bottom--xxl">
                <p>There are not many cities that have good websites, but that is not the case with the small town of Fayette, Missouri. The custom Wordpress theme was designed by <a href="https://rekreate.agency">re•kreate</a>. For the first time in their history they have online bill pay for their city utilities all thanks to the Stripe integration that was catered to their exact needs.</p>                <figure class="wp-block-image size-large">
                    <img src="/assets/images/fayette/fayette-main.jpg" alt="Embracing a simpler life screenshot of home page">
                </figure>
            </div>
        </div>
    </article>
